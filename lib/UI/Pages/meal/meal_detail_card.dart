...
class meal_detail_card extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: (){
          Navigator.of(context).pushNamed(meal_detail.routNName,arguments: model);
      },
    );
  }
  ...
  Widget topInfo(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        ...
        ClipRRect(child: Image.network(model.imageUrl,height: 250.Pt,fit: BoxFit.cover,width: double.infinity,),borderRadius: BorderRadius.only(
        ...
        Positioned(
          ...
          child: Container(
            ...
            width: 250.Pt,
            child: Text(model.title,style: Theme.of(context).textTheme.display3.copyWith(
              color: Colors.white
            )),
          ),
        )
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          operation_samll(Icon(Icons.restaurant), Text('${model.operationStatus}')),
          operation_samll(Icon(Icons.favorite_border), Text('未收藏')),
        ],
